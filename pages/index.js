  ...
  return (
    <>
      ...
      <main style={{ paddingTop: '5rem' }}>
        ...
        {/* HERO */}
        <section style={{ minHeight: '100vh', display: 'grid', gridTemplateColumns: '1fr 1fr', borderBottom: '1px solid var(--border)' }}>
          <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '6rem 4rem 6rem 3rem', borderRight: '1px solid var(--border)' }}>
            <span className="section-label">Author · Speaker · Consultant</span>
            <h1 className="cormorant" style={{ fontSize: 'clamp(3rem,5vw,5.5rem)', lineHeight: 1.05, marginBottom: '2rem' }}>
              People don't resist <em style={{ color: 'var(--warm)', fontStyle: 'italic' }}>buying.</em><br />
              They resist being sold.
            </h1>
            <p style={{ fontSize: '1.05rem', lineHeight: 1.75, color: 'var(--ink-soft)', maxWidth: '460px', marginBottom: '3rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', padding: '6rem 3rem 0 4rem', overflow: 'hidden' }}>
            <div style={{ width: '100%', aspectRatio: '3/4', background: 'linear-gradient(160deg,#E8D5C4 0%,#D4C4B0 100%)', borderRadius: '4px 4px 0 0', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <span className="cormorant" style={{ fontSize: '1rem', color: 'rgba(26,24,20,0.3)', fontStyle: 'italic' }}>Add your photo here</span>
            </div>
          </div>
        </section>
        ...
        <div className="fade-in" style={{ padding: '5rem 3rem', borderBottom: '1px solid var(--border)', display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '4rem', alignItems: 'start' }}>
          ...
          <p className="cormorant" style={{ fontSize: 'clamp(1.6rem,2.5vw,2.4rem)', lineHeight: 1.4 }}>
        ...
        <div className="fade-in" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', borderBottom: '1px solid var(--border)' }}>
          {[
            ...
            <div key={p.n} style={{ padding: '3.5rem 3rem', borderRight: i < 2 ? '1px solid var(--border)' : 'none' }}>
              <div className="cormorant" style={{ fontSize: '3rem', color: 'var(--warm-light)', lineHeight: 1, marginBottom: '1.5rem' }}>{p.n}</div>
              <h3 className="cormorant" style={{ fontSize: '1.4rem', marginBottom: '1rem' }}>{p.title}</h3>
              <p style={{ fontSize: '0.9rem', lineHeight: 1.7, color: 'var(--ink-soft)' }}>{p.body}</p>
            </div>
          ))}
        </div>
        ...
        <section className="fade-in" style={{ padding: '6rem 3rem', borderBottom: '1px solid var(--border)' }}>
          <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: '3rem', paddingBottom: '1.5rem', borderBottom: '1px solid var(--border)' }}>
            <h2 className="cormorant" style={{ fontSize: '2rem' }}>The Books</h2>
            <Link href="/books" style={{ fontSize: '0.75rem', fontWeight: 500, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--warm)', textDecoration: 'none' }}>View all →</Link>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2,1fr)', gap: '2px' }}>
            <Link href="/books/stop-selling" style={{ padding: '3rem', border: '1px solid var(--border)', borderRadius: '2px', display: 'flex', gap: '2rem', textDecoration: 'none', color: 'inherit', background: 'var(--cream)', transition: 'background 0.2s' }}>
              ...
              <div>
                ...
                <h3 className="cormorant" style={{ fontSize: '1.3rem', marginBottom: '0.5rem' }}>Stop Selling. Let Them Buy.</h3>
                <p style={{ fontSize: '0.8rem', color: 'var(--ink-muted)', marginBottom: '0.75rem', fontStyle: 'italic' }}>The Definitive Edition</p>
                <p style={{ fontSize: '0.85rem', lineHeight: 1.65, color: 'var(--ink-soft)' }}>
            ...
            <Link href="/books/translation-problem" style={{ padding: '3rem', border: '1px solid var(--border)', borderRadius: '2px', display: 'flex', gap: '2rem', textDecoration: 'none', color: 'inherit', background: 'var(--cream)', transition: 'background 0.2s' }}>
              ...
              <div>
                <span className="badge">Pre-Sale Live</span>
                <h3 className="cormorant" style={{ fontSize: '1.3rem', marginBottom: '0.5rem' }}>The Translation Problem</h3>
                <p style={{ fontSize: '0.8rem', color: 'var(--ink-muted)', marginBottom: '0.5rem', fontStyle: 'italic' }}>Why workplace conflicts are never what they appear to be</p>
                <p style={{ fontSize: '0.85rem', fontStyle: 'italic', color: 'var(--warm)', marginBottom: '0.5rem' }}>"Every conflict is just two people protecting something they have not named yet."</p>
                <p style={{ fontSize: '0.85rem', lineHeight: 1.65, color: 'var(--ink-soft)' }}>Not a book about difficult people. A book about what happens when two people are both right, both reasonable, and still can't work together.</p>
              </div>
            </Link>
          </div>
        </section>
        ...
        <section className="fade-in" style={{ padding: '5rem 3rem', background: 'var(--ink)', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
          <div>
            ...
            <p style={{ fontSize: '0.95rem', lineHeight: 1.75, color: 'rgba(247,244,239,0.65)', marginBottom: '2rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            {[
              ...
              <div key={f.title} style={{ padding: '1.25rem 1.5rem', border: '1px solid rgba(247,244,239,0.1)', borderRadius: '2px', display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                <div style={{ width: '32px', height: '32px', background: 'rgba(196,98,45,0.2)', borderRadius: '2px', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.8rem', color: 'var(--warm)' }}>{f.icon}</div>
                <div>
                  <p style={{ fontSize: '0.85rem', fontWeight: 500, color: 'var(--cream)', marginBottom: '0.25rem' }}>{f.title}</p>
                  <p style={{ fontSize: '0.8rem', color: 'rgba(247,244,239,0.5)', lineHeight: 1.5 }}>{f.desc}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        {/* TESTIMONIALS */}
        <section className="fade-in" style={{ padding: '6rem 3rem', borderBottom: '1px solid var(--border)' }}>
          <h2 className="cormorant" style={{ fontSize: '2rem', marginBottom: '3rem' }}>What Others Say</h2>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '2rem' }}>
            {[
              ...
              { quote: 'Philip\'s training and strategic guidance drove a complete turnaround in our company. Within 60 days, we broke performance records across multiple departments. His impact was transformational.', author: 'John Y.' },
            ].map(t => (
              <div key={t.author} style={{ padding: '0 0 0 1.5rem', borderLeft: '2px solid var(--warm-light)' }}>
                <p className="cormorant" style={{ fontSize: '1.05rem', fontStyle: 'italic', lineHeight: 1.65, color: 'var(--ink-soft)', marginBottom: '1.25rem' }}>"{t.quote}"</p>
        ...
        <section className="fade-in" style={{ padding: '6rem 3rem', borderBottom: '1px solid var(--border)', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '6rem', alignItems: 'center' }}>
          <div>
            ...
            <h2 className="cormorant" style={{ fontSize: 'clamp(1.8rem,2.5vw,2.6rem)', lineHeight: 1.25, marginBottom: '1.5rem' }}>
              Three-time founder. Forty years in sales. Four books on why people buy.
            </h2>
            <p style={{ fontSize: '0.95rem', lineHeight: 1.8, color: 'var(--ink-soft)', marginBottom: '1.5rem' }}>
              Philip Vivier started selling at twelve years old — watch straps on construction sites in Cape Town, South Africa. He went on to build and sell his own company, lead organizations to national scale, and spend four decades figuring out that the most effective sales tool isn't a better pitch. It's a better understanding of people.
            </p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '1.5rem', paddingTop: '2rem', marginTop: '2rem', borderTop: '1px solid var(--border)' }}>
              {[['40+', 'Years in sales'], ['4', 'Books published'], ['3×', 'Founder']].map(([n, l]) => (
                <div key={l}>
                  <p className="cormorant" style={{ fontSize: '2.5rem', fontWeight: 300, lineHeight: 1, marginBottom: '0.25rem' }}>{n}</p>
                  <p style={{ fontSize: '0.75rem', color: 'var(--ink-muted)' }}>{l}</p>
                </div>
              ))}
            </div>
          </div>
          <div style={{ aspectRatio: '4/5', background: 'linear-gradient(145deg,#E8D5C4 0%,#C8B8A2 100%)', borderRadius: '4px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'Cormorant Garamond, serif', color: 'rgba(26,24,20,0.3)', fontStyle: 'italic' }}>
            Add your photo here
          </div>
        </section>
